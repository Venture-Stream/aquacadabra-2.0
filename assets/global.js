...
class VerticalSlider extends SliderComponent {
  constructor() {
    super();
  }
...
class CountdownTimer extends HTMLElement {
  ...
  initialiseTimer() {
    var clientHours = this.getAttribute('data-hours') || 0;
    var clientMinutes = this.getAttribute('data-minutes') || 0;
    ...
    var x = setInterval(() => {
      ...
      this.querySelector("[data-countdown-time]").innerHTML =  "<span>" + hours + "h" + "</span>"
